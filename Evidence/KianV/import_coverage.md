...
| `$paramod$24edb32283c2798b1a9de01e5e8a5775f3de8d6d\spi_if` | BLOCKED | `clockless_module`, `instance_output_binding`, `yosys_cell` |
| `$paramod$2c2a78eaab39f077d28c359da24eea1bb3ee72ca\sysinfo_if` | ACCEPTED | — |
| `$paramod$492cad6cc1c94f976b64f48c1b13281f93ce86b9\associative_cache` | BLOCKED | `clockless_module`, `memory_cell`, `yosys_cell` |
...
| `$paramod$530c0f32123495a95a65ef2dee5adb9a30a708f6\spi_if` | BLOCKED | `clockless_module`, `instance_output_binding`, `yosys_cell` |
...
| `$paramod$6e553a45e44facf149505def5cdbbf99f283bb05\lru_replacement` | BLOCKED | `clockless_module`, `memory_cell` |
...
| `$paramod$97c33ce1f197c7d09a6065d46e5aec5f4fa18127\Word_Reducer` | BLOCKED | `clockless_module`, `instance_output_binding`, `yosys_cell` |
| `$paramod$9b7a6de76a656f235265b36ced3b9a85d704f591\fifo` | BLOCKED | `four_state_constant`, `memory_cell` |
| `$paramod$9e9c3eac67bdfcffcee59edb9321066a49ebd9bc\gpio_if` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `$paramod$a16ae7440305347911693e8e0f29ccf27deb10d1\sv32` | BLOCKED | `four_state_constant`, `instance_output_binding`, `yosys_cell` |
| `$paramod$a39b4da5cbc02a0ba8e2c33f3a070905ed9e4012\kianv_harris_mc_edition` | BLOCKED | `clockless_module`, `instance_output_binding`, `yosys_cell` |
| `$paramod$b21d8177f76650034fcf5c651716b86b29dd0174\spi_nor_if` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `$paramod$e0de9e5afae9227897f68c4fd4bf06762d640101\Bit_Reducer` | BLOCKED | `clockless_module` |
...
| `$paramod\Bitmask_Isolate_Rightmost_1_Bit\WORD_WIDTH=s32'00000000000000000000000000100000` | BLOCKED | `clockless_module` |
| `$paramod\Logarithm_of_Powers_of_Two\WORD_WIDTH=s32'00000000000000000000000000100000` | BLOCKED | `clockless_module`, `instance_output_binding`, `yosys_cell` |
| `$paramod\Priority_Encoder\WORD_WIDTH=s32'00000000000000000000000000100000` | BLOCKED | `clockless_module`, `instance_output_binding`, `yosys_cell` |
| `$paramod\cache\BYPASS_CACHES=1'0` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `$paramod\clint_if\BASE_HI=8'00000010` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `$paramod\counter\WIDTH=s32'00000000000000000000000001000000` | ACCEPTED | — |
| `$paramod\datapath_unit\RESET_ADDR=32'00100000000100000000000000000000` | BLOCKED | `clockless_module`, `instance_output_binding`, `yosys_cell` |
...
| `$paramod\mux2\WIDTH=s32'00000000000000000000000000100000` | BLOCKED | `clockless_module` |
| `$paramod\mux4\WIDTH=s32'00000000000000000000000000100000` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `$paramod\mux5\WIDTH=s32'00000000000000000000000000100000` | BLOCKED | `clockless_module` |
| `$paramod\mux6\WIDTH=s32'00000000000000000000000000100000` | BLOCKED | `clockless_module` |
| `$paramod\plic_if\BASE_HI=8'00001100` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `$paramod\spi\CPOL=1'0` | BLOCKED | `multiple_reset_domains` |
| `alu` | BLOCKED | `clockless_module`, `yosys_cell` |
| `alu_decoder` | BLOCKED | `clockless_module`, `four_state_constant`, `memory_cell` |
| `chip_core` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `clint` | ACCEPTED | — |
| `control_unit` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `csr_decoder` | BLOCKED | `clockless_module` |
| `csr_exception_handler` | BLOCKED | `clockless_module`, `instance_output_binding` |
...
| `divider_decoder` | BLOCKED | `clockless_module`, `four_state_constant` |
| `extend` | BLOCKED | `clockless_module` |
...
| `load_alignment` | BLOCKED | `clockless_module`, `four_state_constant` |
| `load_decoder` | BLOCKED | `clockless_module`, `four_state_constant` |
...
| `multiplier_decoder` | BLOCKED | `clockless_module`, `four_state_constant` |
| `multiplier_extension_decoder` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `mux2` | BLOCKED | `clockless_module` |
| `plic` | BLOCKED | `instance_output_binding`, `yosys_cell` |
| `register_file` | BLOCKED | `clockless_module`, `memory_cell` |
...
| `sram_sp_gf180_512x56` | BLOCKED | `clockless_module`, `instance_output_binding` |
| `store_alignment` | BLOCKED | `clockless_module`, `four_state_constant` |
| `store_decoder` | BLOCKED | `clockless_module`, `four_state_constant` |
