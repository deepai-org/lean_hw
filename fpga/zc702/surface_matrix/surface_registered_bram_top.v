...
module surface_registered_bram_top (
    ...
    loom_system u_matrix (
      ...
      .sink_ordinary_d4__run_limit(sink_run_limit),
    ...
    assign leds[2] = delivered == sink_run_limit;
